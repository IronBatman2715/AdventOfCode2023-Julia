...
@testset "Day 12" begin
    ...
    @test part_1 == 6827
    @test part_2 == 1537505634471
end

@testset "Day 13" begin
    part_1, part_2 = AdventOfCode2023.Day13.run()
    @test part_1 == 29165
    @test part_2 == 32192
end

@testset "Day 14" begin
    part_1, part_2 = AdventOfCode2023.Day14.run()
    @test part_1 == 105982
    @test part_2 == 85175
end

@testset "Day 15" begin
    part_1, part_2 = AdventOfCode2023.Day15.run()
    @test part_1 == 510013
    @test part_2 == 268497
end

@testset "Day 16" begin
    part_1, part_2 = AdventOfCode2023.Day16.run()
    @test part_1 == 7472
    @test part_2 == 7716
end
